...
sfc_ID_filepath    = '{}/{}/{}'.format(PTA_path, config['supporting directories']['Surface_IDs'], 'surfaceID_LosAngeles_048.nc')
...
Target_Area_X      = 1#int(config['Target Area Integer'][PTA])
#ROME
