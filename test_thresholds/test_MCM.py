...
threshold_filepath = '{}/{}/{}'.format(PTA_path, config['supporting directories']['thresh'], 'reproj_sfcID_thresh/thresholds_DOY_113_to_120_bin_14.h5')
print(threshold_filepath)
sfc_ID_filepath    = '{}/{}/{}'.format(PTA_path, config['supporting directories']['Surface_IDs'], 'reprojected_SID/surfaceID_LA_120.nc')
