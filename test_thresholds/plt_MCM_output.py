...
for time_stamp, test_data_JPL_path in zip(time_stamps, test_data_JPL_paths):
    ...
    for i, a in enumerate(ax.flat):
        ...
        if i==0:
            ...
            cax = f.add_axes([0.75, 0.1, 0.025, 0.25])
            ...
            a.set_title('SID')
            cax = f.add_axes([0.85, 0.1, 0.025, 0.25])
        ...
        #plot DTT first
            ...
            im.cmap.set_under('k')
            cax = f.add_axes([0.95, 0.1, 0.025, 0.25])
        ...
        #add colorbars for mod35/SID/DTT in last empty axis
